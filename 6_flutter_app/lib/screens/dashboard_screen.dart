...
class DashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('NammaClimaGrid'),
        actions: [
          // Live clock
          Center(
            child: Row(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ref.watch(wardRisksProvider).maybeWhen(
      data: (resp) {
        ...
        final nHigh =
            wards.where((w) => w.riskLevel == 'high').length;

        return Container(
          color: const Color(0xFF1B6B3A).withOpacity(0.07),
          padding:
        ...
        children: [
          ...
          ...levels.map((lvl) => Padding(
                ...
                child: _chip(
                  ...
                  onTap: () =>
                      ref.read(riskLevelFilterProvider.notifier).state =
                          selected == lvl ? null : lvl,
                ),
              )),
        ],
      ),
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (ward.temperatureC != null || ward.lstPredCelsius != null) ...[
                      const SizedBox(height: 2),
                      Row(
                        children: [
                          Text(
                          ...
                          if (ward.rainfallMm != null && ward.rainfallMm! > 0) ...[
                            const SizedBox(width: 4),
                            Text(
